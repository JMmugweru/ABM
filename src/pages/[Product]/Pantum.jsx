  ...
  return (
    <div className="">
      ...
      <div className="container mx-auto p-3 my-4">
        <small className="text-red-800 text-xs font-bold">PANTUM COLOR​</small>
        <h2 className="text-2xl text-[#131d3b] font-semibold">Pantum Color</h2>
        <img
          src=""
          alt=""
